...
export class HttpApiClient implements ElectronAPI {
  ...
  worktree: WorktreeAPI = {
    ...
    commit: (worktreePath: string, message: string, selectedFiles?: string[]) =>
      this.post('/api/worktree/commit', { worktreePath, message, selectedFiles }),
    getChangedFiles: (worktreePath: string) =>
      this.post('/api/worktree/changed-files', { worktreePath }),
    ...
    stashAndSwitch: (worktreePath: string, branchName: string) =>
      this.post('/api/worktree/stash-and-switch', { worktreePath, branchName }),
    checkoutRemoteBranch: (
      worktreePath: string,
      remoteBranchName: string,
      stashChanges?: boolean
    ) =>
      this.post('/api/worktree/checkout-remote-branch', {
        worktreePath,
        remoteBranchName,
        stashChanges,
      }),
